...
if ((numeroUn==stringUn)&&(typeof stringUn!=typeof numeroUn)) {
  ...
  // vrsion 2 modificando las respuestas

  if ((numeroUn==stringUn)&&(typeof stringUn!=typeof numeroUn)) {

    console.log('Las variables numeroUn y stringUn tienen el mismo valor, pero tipos diferentes')
  
  } else if ((numeroUn==stringUn)&&(typeof stringUn==typeof numeroUn))  {
  
    console.log('Las variables numeroUn y stringUn tienen el mismo valor y l mismo tipo')
...
if ((numeroDiez==stringDiez)&&(typeof stringDiez!=typeof numeroDiez)) {
